            ...
            <div class="container-fluid">
                <div class="row" style="width:3000px;  height: 70px; font-size:80%;">
                    <div class="col-md-4">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Are you sure you want to start observation?	</h4>
                                <p class="category">Get Notified</p>
                            </div>
                            <div class="content">
                               
                            <form name = "startobservation" action = "SplashScreen.jsp">
                            
         <button class="yes" type="submit" style="background-color:#4CAF50; width:80px; height:45px" >Yes</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <button class="no" type="reset" style="background-color:#F44336; width:80px; height:45px">No</button>  
