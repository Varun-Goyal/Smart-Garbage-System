            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="header">
                        ...
                        <p class="category">Handcrafted by <a target="_blank" href="http://varungoyal.netne.net/me.html">Varun Goyal</a>. Please checkout the <a href="http://bootstrap-notify.remabledesigns.com/" target="_blank">full documentation.</a></p>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-md-offset-3 text-center">
                                    <h5>Notifications Places
                                        <p class="category"><a href = "realtimenotifications.jsp">Click to view notifications</a></p>
                                    </h5>
                                </div>
                            </div>
                            <div class="row">
